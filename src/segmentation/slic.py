...
class Slic(Segmenter, SkimageSegmenter):
    ...
    # CURRENTLY CONFIGURED FOR WORK WITH ALMOND DATASETS BY DEFAULT
    def __init__(self, n_segments = 800, sigma = 1.5, compactness = 50.0, border_color = 'Yellow', border_outline = 'No'):
        """Constructor.
